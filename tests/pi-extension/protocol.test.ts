...
import { LANGUAGE_PACK_VERSION, PACKAGE_VERSION, PLATFORM, TARGET } from "../../extensions/pi-cx/types.js";
...
test("validates the fixed asset contract", () => {
  ...
  const manifest = { format_version: 1, package: "pi-cx", cx_version: PACKAGE_VERSION, cx_schema_version: 1, target: TARGET, tree_sitter_language_pack_version: LANGUAGE_PACK_VERSION, languages: ["rust", "c", "cpp", "javascript", "jsx", "typescript", "tsx", "python", "go"], files: { [`bin/${PLATFORM.binaryName}`]: file, ...Object.fromEntries(["rust", "typescript", "tsx", "python", "go", "c", "cpp"].map(name => [`grammars/${grammarFilename(name)}`, file])) } };
