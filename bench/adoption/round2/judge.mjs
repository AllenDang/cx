...
import { inspectTrial } from './lib.mjs';
...
const target = valid.filter(r => r.model === 'aliyun/deepseek-v4.1-flash');
...
const verdict = { pass: !infrastructure && passed === rows.length && meaningful >= required,
